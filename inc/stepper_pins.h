...
#define EXTRUDER_STEPPER 0
#define EXTRUDER_STEPPER_PIN(PIN) STEPPER_##EXTRUDER_STEPPER_##
#define EXTRUDER_CS EXTRUDER_STEPPER_PIN(CS)
#define EXTRUDER_EN EXTRUDER_STEPPER_PIN(EN)
#define EXTRUDER_STP EXTRUDER_STEPPER_PIN(STP)
